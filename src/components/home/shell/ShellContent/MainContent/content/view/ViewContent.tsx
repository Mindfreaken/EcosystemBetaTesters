      ...
      <Box sx={{ maxWidth: 920, mx: "auto", textAlign: "center", mt: 2 }}>
        ...
        >
          ...
          <Typography variant="body2" sx={{ mt: 0.75, color: themeVar("textSecondary") }}>
            Tell us what you want to see: feeds, creator tools, playlists, short clips, comments, and more.
            Share a wishlist of features and layouts that would make this great for you.
          </Typography>
        </Box>
